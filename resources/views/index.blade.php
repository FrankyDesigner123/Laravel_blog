                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{ route('category.single', ['id' => $third_post->category->id ]) }}">{{ $third_post->category->nam }}</a>
                                        </span>
            ...
            <div class="container">
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach($sport->posts()->orderBy('created_at', 'desc')->take(3)->get() as $post)
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $websummit->name }}</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                          @foreach($websummit->posts()->orderBy('created_at', 'desc')->take(3)->get() as $post)
